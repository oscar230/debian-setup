...
# General apps
sudo apt-get install -y automake vim dconf-editor wget curl git git chromium vlc onionshare audacity libreoffice libreoffice-gnome texlive-full htop default-jre transmission filezilla gimp gparted p7zip-full nmap alacarte afl ffmpeg tesseract-ocr keepassxc mat2
